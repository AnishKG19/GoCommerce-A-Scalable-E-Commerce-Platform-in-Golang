...
import (
	...
	// models "command-line-argumentsC:\\Users\\RAHUL GUPTA\\Desktop\\GO_Proj\\ecommerce-yt\\models.go"
...
func SearchProduct() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		if err != nil {
			c.IndentedJSON(http.StatusInternalServerError, "Something went wrong try after sometime")
			return
		}

...
var (
	...
	ErrCantDecodeProducts  = errors.New("cn't find the products")
	ErrUserIdIsNotValid = errors.New("this user is not valid ")
	ErrCantUpdateUser = errors.New("cannot add product to the cart")
...
func BuyItemFromCart( ctx context.Context , userCollection *mongo.Collection , userID string  ) error {
	...
	ordercartt.Ordered_At = time.Now()
	...
	updated3 := bson.D{{Key:"$set", Value:bson.D{primitive.E{Key:"usercart", Value: usercart_empty}}}}
...
func InstantBuyer( ctx context.Context , prodCollection , userCollection *mongo.Collection , productID primitive.ObjectID , userID string  )  error  {
	...
	if err != nil {
	 ...
	 filter := bson.D{primitive.E{Key:"_id" , Value :id }}
	 update := bson.D{{Key:"$push", Value:bson.D{primitive.E{Key:"orders", Value: usercart_empty}}}}
	 ...
	 _,err = userCollection(ctx, filter2 ,update2 )
